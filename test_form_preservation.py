#!/usr/bin/env python3
"""
Test script to demonstrate improved form data preservation.
This script will submit a form with mixed valid/invalid data to show
how valid fields are preserved while invalid ones show errors.
"""
...
def test_form_preservation():
    """Test the improved form data preservation feature"""
